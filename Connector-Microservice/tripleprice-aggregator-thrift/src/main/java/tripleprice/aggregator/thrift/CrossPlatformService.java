...
public class CrossPlatformService {
  ...
  public interface AsyncIface {
    ...
    public void save(CrossPlatformResource resource, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.save_call> resultHandler) throws org.apache.thrift.TException;

    public void getList(org.apache.thrift.async.AsyncMethodCallback<AsyncClient.getList_call> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void save(CrossPlatformResource resource, org.apache.thrift.async.AsyncMethodCallback<save_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
    ...
    public static class save_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public save_call(CrossPlatformResource resource, org.apache.thrift.async.AsyncMethodCallback<save_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
    ...
    public void getList(org.apache.thrift.async.AsyncMethodCallback<getList_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
    ...
    public static class getList_call extends org.apache.thrift.async.TAsyncMethodCall {
      public getList_call(org.apache.thrift.async.AsyncMethodCallback<getList_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
      }
  ...
  public static class get_result implements org.apache.thrift.TBase<get_result, get_result._Fields>, java.io.Serializable, Cloneable   {
    ...
    private CrossPlatformResource success; // required
    private InvalidOperationException e; // required
    ...
    public void setSuccess(CrossPlatformResource success) {
      this.success = success;
    }
    ...
    public void setE(InvalidOperationException e) {
      this.e = e;
    }
  ...
  public static class save_args implements org.apache.thrift.TBase<save_args, save_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    private CrossPlatformResource resource; // required
    ...
    public void setResource(CrossPlatformResource resource) {
      this.resource = resource;
    }
...
;
  ...
  public static class getList_result implements org.apache.thrift.TBase<getList_result, getList_result._Fields>, java.io.Serializable, Cloneable   {
    ...
    private List<CrossPlatformResource> success; // required
    private InvalidOperationException e; // required
    ...
    public getList_result(getList_result other) {
      if (other.isSetSuccess()) {
        List<CrossPlatformResource> __this__success = new ArrayList<CrossPlatformResource>();
    ...
    public void setSuccess(List<CrossPlatformResource> success) {
      this.success = success;
    }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  {
                    CrossPlatformResource _elem2; // required
        ...
        if (incoming.get(0)) {
          {
            ...
            {
              CrossPlatformResource _elem7; // required
