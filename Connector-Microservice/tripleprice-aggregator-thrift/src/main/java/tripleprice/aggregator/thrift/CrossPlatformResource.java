...
public class CrossPlatformResource implements org.apache.thrift.TBase<CrossPlatformResource, CrossPlatformResource._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(CrossPlatformResource other) {
    ...
    CrossPlatformResource typedOther = (CrossPlatformResource)other;
    ...
    lastComparison = Boolean.valueOf(isSetSalutation()).compareTo(typedOther.isSetSalutation());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSalutation()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.salutation, typedOther.salutation);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
